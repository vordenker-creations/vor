...
class AICareerBridgeEnterprise(ctk.CTk):
    ...
    def setup_sidebar(self):
        ...
        logo_frame.pack(pady=(20, 10), fill="x", padx=20)
        ctk.CTkLabel(logo_frame, text="🎓", font=ctk.CTkFont(size=28), text_color=COLOR_PRIMARY).pack(side="left", padx=(0, 10))
        text_logo_frame = ctk.CTkFrame(logo_frame, fg_color="transparent")
        text_logo_frame.pack(side="left")
        ctk.CTkLabel(text_logo_frame, text="BRIDGE", font=ctk.CTkFont(family=FONT_MAIN, size=18, weight="bold"), text_color=COLOR_TEXT_MAIN).pack(anchor="w", pady=0)
        ...
        self.menu_container = ctk.CTkScrollableFrame(self.sidebar, fg_color="transparent")
        self.menu_container.pack(fill="both", expand=True, padx=5, pady=0)
    ...
    def create_nav_btn(self, page_name, icon, text):
        btn_container = ctk.CTkFrame(self.menu_container, fg_color="transparent")
        btn_container.pack(fill="x", padx=10, pady=2)
    ...
    def setup_topbar(self):
        ...
        ctk.CTkLabel(user_frame, text="Bùi Hậu", font=ctk.CTkFont(family=FONT_MAIN, size=13, weight="bold"), text_color=COLOR_TEXT_MAIN).pack(anchor="e")
