...
from PyQt6.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLabel, 
                             QPushButton, QSpacerItem, QSizePolicy, QLineEdit, QFrame, QGraphicsDropShadowEffect)
    ...
    def __init__(self, steps, current_step=0, parent=None):
        ...
        for i, step_text in enumerate(steps):
            ...
            if i > 0:
                ...
                line_before.setStyleSheet(f"background-color: {COLOR_PRIMARY if i <= current_step else COLOR_BORDER}; border: none;")
            ...
            if i < len(steps) - 1:
                ...
                line_after.setStyleSheet(f"background-color: {COLOR_PRIMARY if i < current_step else COLOR_BORDER}; border: none;")
...
class RegisterPage(QWidget):
    def __init__(self, parent=None, on_back_click=None, on_register=None):
        ...
        help_btn.setStyleSheet(f"color: {COLOR_TEXT_SECONDARY}; font-size: 13px; font-weight: 600; border: none; background: transparent; padding-left: 15px;")
        ...
        title_lbl.setStyleSheet(f"color: {COLOR_TEXT_PRIMARY}; font-size: 28px; font-weight: 800; letter-spacing: -0.5px;")
        
        subtitle_lbl = QLabel("Start your 14-day free trial. No credit card required.")
        ...
        self.first_name_input = ModernInput("First Name", "Jane", "👤")
        self.last_name_input = ModernInput("Last Name", "Doe", "")
    ...
    def _handle_register(self):
        ...
        try:
            crud.save_student_profile(email, fullname, "")
            if self.on_register:
