...
class GeneratorNavItem(QPushButton):
...
class RoadmapGeneratorSidebar(QFrame):
    ...
    def setup_ui(self):
        ...
        """)
        header_v.addWidget(self.btn_new)
        ...
        search_input.setPlaceholderText("Search roadmaps...")
        ...
        sections = [
            ("PLANNING", ["My Roadmaps", "AI Generated", "Saved Templates"]),
            ("CURRICULUM", ["Career Tracks", "Weekly Plans", "Milestone Systems"]),
            ("ARCHIVE", ["Learning Archives"])
        ]
        ...
        v_h.addWidget(v_lbl); v_h.addStretch(); stl.addLayout(v_h)
        
        pb = QProgressBar()
        pb.setFixedHeight(6); pb.setValue(60); pb.setTextVisible(False)
