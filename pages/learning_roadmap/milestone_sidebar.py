...
class MilestoneSidebar(QFrame):
    ...
    def setup_ui(self):
        ...
        """)
        header_v.addWidget(self.btn_create)
        ...
        self.search_input.setPlaceholderText("Search milestones...")
        ...
        sections = [
            ("COLLECTIONS", ["Active Milestones", "Upcoming Goals", "Completed Goals", "Delayed Progress"]),
            ("INTELLIGENCE", ["AI Suggestions", "Weekly Objectives", "Achievements"])
        ]
        ...
        for section_title, items in sections:
            ...
            for item in items:
                ...
                if item == "Active Milestones": btn.setChecked(True)
        ...
        add_stat("Completed", "18")
        add_stat("Streak", "12 Days", "#10B981")
        add_stat("Overall", "45%", "#38BDF8")
